<header class="py-8 bg-gray-700">
    ...
    <div class="max-w-screen-xl px-4 py-4 mx-auto font-light text-base text-white sm:px-6 lg:px-8">
        ...
        <p>
            {!! __("To learn more about PHP's support schedule, check out the :link.", ['link' => '<a href="https://www.php.net/supported-versions.php" class="text-indigo-300 hover:text-indigo-400 underline">' . 'PHP "Supported Versions" page' . '</a>']) !!}
        </p>
    </div>
</header>
